...
urlpatterns = [
    ...
    path('Partners', classroom.part_view_add, name='partners'),
...
#DIT
    ...
    path('database/dit/', classroom.Dit.as_view(), name='data_dit'),
    path('database/dit/co_creation', classroom.Co_creation.as_view(), name='co_creation'),
    path('database/dit/open_manufacturing', classroom.Open_manuf.as_view(), name='open_manufa'),


#DataBase

    path('database/process/', classroom.DataBaseView.as_view(), name='data_base'),
    path('database/process/activ/(?P<int:pk>\d+)/', classroom.ActivBaseView.as_view(), name='activ_base'),

    path('database/process/activ/tasks/(?P<int:pk>\d+)/', classroom.TaskBaseView.as_view(), name='task_base'),

    path('database/process/activ/tasks/details/(?P<int:pk>\d+)/', classroom.TaskDetaiListView.as_view(), name='task_base_display'),

    #add this one
    path('database/process/activity/details/(?P<int:pk>\d+)/', classroom.ActivDetaiListView.as_view(), name='activ_base_display'),

#Search Items
    path('Research/items/', classroom.Research, name='search_items'),
    path('Table/items/', classroom.Table.as_view(), name='table_items'),
    path('Research/items/activity/(?P<int:pk>\d+)/', classroom.ActivSearchView.as_view(), name='activ_search'),

    #detail_of_search
    path('Research/Items/datail/(?P<int:pk>\d+)/', classroom.SearchDetailView.as_view(), name='detail_research_view'),
...
#add activity
    ...
    path('add_task/', classroom.add_task_view.as_view(), name='add_task_g'),
