...
from  classroom.filters import ProcessFilter, ActivityFilter
...
class ActivDetaiListView(ListView):
    model = Activity
    template_name = 'Home/DataBase/activ_display.html'
    context_object_name = 'activ'
    ...
    def get_context_data(self, **kwargs):
        context = super(ActivDetaiListView, self).get_context_data(**kwargs)
        context['activ'] = get_object_or_404(Activity, pk=self.kwargs['pk'])
        return context
...
def part_view_add(request):
    template_name = 'Home/Part/partenaire.html'
    process= Process.objects.all()
    activity= Activity.objects.all()
    return render(request, template_name, {"process": process, "activity": activity})
...
class Dit(ListView):
    ...
    template_name= 'Home/Dot/home.html'
    ...
    def get_context_data(self, **kwargs):
        context = super(Dit, self).get_context_data(**kwargs)
        process= Process.objects.all()
...
class Open_manuf(ListView):
    model = Process
    ordering=('process_name')
    context_object_name='processes'
    template_name= 'Home/Dot/open_manufa.html'
    ...
    def get_context_data(self, **kwargs):
        context = super(Open_manuf, self).get_context_data(**kwargs)
        process= Process.objects.all()
        total_sales = {} # create an empty dictionary
        for day in process:
            # get the sales for that particular day
...
class Co_creation(ListView):
    model = Process
    ordering=('process_name')
    context_object_name='processes'
    template_name= 'Home/Dot/co_creation.html'
    ...
    def get_context_data(self, **kwargs):
        context = super(Co_creation, self).get_context_data(**kwargs)
        process= Process.objects.all()
        total_sales = {} # create an empty dictionary
        for day in process:
            # get the sales for that particular day
...
class ActivSearchView(ListView):
    model = Activity
    ordering=('activety_name')
    context_object_name='acti'
    template_name= 'Home/SearchItems/activities.html'
    ...
    def get_context_data(self, **kwargs):
        context = super(ActivSearchView, self).get_context_data(**kwargs)
...
def Research(request):
    ...
    return render(request, template_name, {'filter' : process_filter, 'process':process,'activity':activity, 'activity_filter':activity_filter, 'process_list': process_list})
...
class TaskDetaiListView(CreateView):
    model = Task
    ...
    def get_context_data(self, **kwargs):
        context = super(TaskDetaiListView, self).get_context_data(**kwargs)
        context['task'] = get_object_or_404(Task, pk=self.kwargs['pk'])
        return context
...
class add_input_element(CreateView):
    model = Input
    fields = ['input_name', 'definition', 'part', 'task_id' ]
...
class add_output_element(CreateView):
    model = Output
    fields = ['output_name', 'definition', 'part', 'task_id']
    ...
    def get_context_data(self, **kwargs):
        context = super(add_output_element, self).get_context_data(**kwargs)
        context['task'] = get_object_or_404(Task, pk=self.kwargs['pk'])
        return context
...
class add_dec_element(CreateView):
    model = Decision
    fields = ['decision_name', 'definition', 'part', 'task_id']
...
class add_tech_element(CreateView):
    model = Technologie
    fields = ['technologie_name', 'technology_maturity','definition', 'part', 'task_id']
...
class add_skill_element(CreateView):
    model = Skill
    fields = ['skills_name', 'skills_maturity', 'definition', 'part', 'task_id']
